...
- Real-time chat, voice, threads, and moderation systems
- Product polish across React, React Native, Electron, and Node.js
- Turning Gratonite into a friend-first community platform without ads or phone-verification gates
